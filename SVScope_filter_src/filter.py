...
filtered_del_df.to_csv(vcf_data_dir + vcf_name + ".vcf_del", sep="\t", index=False)
filtered_ins_df.to_csv(vcf_data_dir + vcf_name + ".vcf_ins", sep="\t", index=False)
...
filtered_del_df = pd.read_csv(vcf_data_dir + vcf_name + ".vcf_del", sep="\t", skiprows=1, header=None)

ins_file_path = vcf_data_dir + vcf_name + ".vcf_ins"
